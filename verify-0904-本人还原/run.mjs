...
async function buildContact() {
  const panels = await Promise.all([
    ...
    contactPanel(ANCHOR_PATH, 'derived anchor · Gemini Pro'),
    contactPanel(LOOK_PATH, 'follow_scene · GPT Image 2'),
  ]);
...
const results = {
  experiment: '09-04 follow_scene same-person end-to-end verification',

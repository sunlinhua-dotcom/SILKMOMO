...
She is a 24-28 year old agency fashion model. Strictly match the ethnicity, face shape, facial features, hair color, and hairstyle of the model in the scene reference image; generate a front-facing identity portrait card of the same model. Slight beautification is allowed, but do not change her ethnicity or overall appearance. Her face is specific and memorable, with the small asymmetries a real face has — one eye opening slightly wider, one brow a little higher.
